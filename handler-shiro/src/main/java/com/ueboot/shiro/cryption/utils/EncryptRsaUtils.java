package com.ueboot.shiro.cryption.utils;

import com.google.common.collect.Maps;
import com.ueboot.shiro.cryption.constants.EncryptConstants;
...
public class EncryptRsaUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String data02 = encryptedDataOnJava("47.100.242.77", "PBEWithMD5AndDES");
        System.out.println(data02);
        String java = decryptDataOnJava(data, "PBEWithMD5AndDES");
